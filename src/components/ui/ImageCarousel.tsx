  ...
  return (
    <div className="px-4">
      <div className="relative w-full max-w-6xl mx-auto bg-background rounded-2xl overflow-hidden shadow-2xl">
        <div
          className="relative h-[57vh] md:h-[600px] overflow-hidden bg-black"
        ...
        >
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              <div className="relative w-full h-full">
                ...
                {/* ADDED: Uniform very light dark shade overlay */}
          ...
          >
            <ChevronLeft className="w-5 h-5 md:w-6 md:h-6 text-[#BCA88D]" />
          </button>
          <button
            onClick={handleNext}
          ...
          >
            <ChevronRight className="w-5 h-5 md:w-6 md:h-6 text-[#BCA88D]" />
          </button>
          ...
          >
            {isPlaying ? (
              <Pause className="w-4 h-4 md:w-5 md:h-5 text-[#BCA88D]" />
            ) : (
              <Play className="w-4 h-4 md:w-5 md:h-5 text-[#BCA88D]" />
            )}
          </button>
        </div>
              ...
              {slides.map((_, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    currentIndex === index ? "w-8 bg-[#BCA88D]" : "w-2 bg-[#BCA88D]/20 hover:bg-muted-foreground",
                  )}
